...
This assignment is worth 15% of final grade.
Submission:

Include your completed worksheet inside your ZIP submission file. The hierarchy of the ZIP's contents should be:

    [Last name]-[First name]-A1.zipRoot folder - [Last name]-[First name]-A1
    Unity project folder - Assets, Packages, Project Settings only!
    A1Worksheet.docx
    APK file

Submit your assignment here: Build and Deploy a Mobile Microgame using NavMesh.
Assignment Due
